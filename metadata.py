...
BASE_IMAGE_URL = "ipfs://QmWvEkQBWwVwp8ckRX2nQgMEg23FygJZXJTMku7ZshhWsS"
BASE_NAME = "Drako Dragoon v2 #"

BASE_JSON = {
    "name": BASE_NAME,
    "description": "A collection of 1,600 Drako Dragoon NFTs on the blockchain",
